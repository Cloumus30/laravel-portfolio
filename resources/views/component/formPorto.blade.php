...
<main class="w-full md:w-10/12 text-white bg-[#060047] max-h-screen overflow-auto">
    <div class="p-5">
        <form id="form-porto" action="{{$linkForm}}" method="POST" onsubmit="submitFormPorto(this)" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                <label for="short-desc" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi Singkat</label>
                <textarea id="short-desc" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Aplikasi Ini Adalah..." name="short_desc">{{$data['short_desc']}}</textarea>
